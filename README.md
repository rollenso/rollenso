...
*   *RTOS:* FreeRTOS, Apache NuttX
*   *Protocols:* I2C, SPI, UART, MIDI, MIPI
*   LVGL (for embedded UI)
*   *Design:* KiCad (schematic, PCB), SPICE simulation
...
Bachelor | electronics and nanoelectronics
